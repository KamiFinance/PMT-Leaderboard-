...
const NETWORK_PHOTOS = [
  ...Array.from({length:8},(_,i)=>`${BASE}network_${i+1}.jpg?v=2`),
  ...Array.from({length:6},(_,i)=>`${BASE}network_${i+9}.jpg`),
]
  ...
  return (
    <div className="lp" dir={lang.dir}>
      ...
      <section className="lp-hero" id="hero">
        <div className="lp-hero-david"><img src={`${BASE}david.webp?v=3`} alt="" aria-hidden="true"/></div>
